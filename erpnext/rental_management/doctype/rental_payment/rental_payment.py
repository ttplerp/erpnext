...
class RentalPayment(AccountsController):
	...
	def calculate_totals(self):	
		...
		for a in self.items:
			...
			a.total_amount_received = round(a.rent_received) + round(a.security_deposit_amount) + round(a.penalty) + round(a.excess_amount) + round(a.pre_rent_amount_received)
			...
			total_amount_received += round(a.rent_received) + round(a.security_deposit_amount) + round(a.penalty) + round(a.excess_amount) + round(a.pre_rent_amount_received)
		...
		self.total_amount_received = round(total_amount_received)
			...
			for a in self.get('items'):
				if a.rental_bill:
					...
					doc.append("rental_payment_details",{
									...
									"pre_rent_amount"  : flt(a.pre_rent_amount_received),
									"tds_on_pre_rent_amount"  : flt(a.tds_pre_rent_amount),
	...
	def get_rental_bills(self):
		...
		return {"number_of_rental_bill":self.number_of_rental_bill, "total_bill_amount":total_bill_amount, "rent_write_off_amount":rent_write_off_amount, "total_rent_amt": flt(total_bill_amount)}
