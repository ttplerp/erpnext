...
var create_custom_buttons = function(frm){
	...
	if(frm.doc.docstatus == 1 && (frm.doc.payment_type == "Pay" || frm.doc.payment_type == "Internal Transfer")  && (frm.doc.mode_of_payment == "e-payment" || frm.doc.party_type == 'Supplier' || frm.doc.party_type == 'Employee') ){
