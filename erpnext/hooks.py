...
scheduler_events = {
	"cron": {
		...
		"0 0 * * *": [
			# "erpnext.stock.utils.send_safety_stock_notification",
		]
	...
	"monthly_long": [
		...
		"erpnext.custom_utils.updateHousingApplicantsdata",
	],
}
...
permission_query_conditions = {
	...
	"POL Advance": "erpnext.fleet_management.doctype.pol_advance.pol_advance.get_permission_query_conditions",
