...
@frappe.whitelist()
def get_finance_book_details(asset_sub_category):
	depreciation_method, total_number_of_depreciations, frequency_of_depreciation,depreciation_start_date, income_depreciation_percent = frappe.db.get_value("Asset Finance Book", {"asset_sub_category": asset_sub_category}, 
	["depreciation_method","total_number_of_depreciations","frequency_of_depreciation", "depreciation_start_date", "income_depreciation_percent"])

	return [depreciation_method, total_number_of_depreciations, frequency_of_depreciation,
	depreciation_start_date, income_depreciation_percent]
