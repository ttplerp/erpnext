...
def get_permission_query_conditions(user):
	...
	if "HR User" in user_roles or "HR Manager" in user_roles or "Accounts User" in user_roles or "CEO" in user_roles or "ADM User" in user_roles:
		return
	else:
		return """(
			exists(select 1
...
def has_record_permission(doc, user):
	...
	if "HR User" in user_roles or "Accounts User" in user_roles or "HR Manager" in user_roles or "ADM User" in user_roles:
		return True
	else:			
